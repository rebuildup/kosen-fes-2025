...
function generateStaticHTML(route) {
  ...
  let title = "宇部高専文化祭2025";
  let description =
    "宇部高専文化祭2025の公式サイト テーマはPOP! イベント/展示/屋台の情報を掲載";

  switch (route) {
    case "/events":
      title = "イベント一覧 | 宇部高専文化祭2025";
      description =
        "宇部高専文化祭2025のイベント一覧。ライブ、パフォーマンス、催し物の詳細情報。";
      break;
    case "/exhibits":
      title = "展示一覧 | 宇部高専文化祭2025";
      description =
        "宇部高専文化祭2025の展示一覧。学生作品、研究成果、技術展示の詳細情報。";
      break;
    case "/schedule":
      title = "スケジュール | 宇部高専文化祭2025";
      description =
        "宇部高専文化祭2025のタイムスケジュール。各イベントの開催時間を確認。";
      break;
    case "/map":
      title = "キャンパスマップ | 宇部高専文化祭2025";
      description =
        "宇部高専キャンパスマップ。各展示・屋台の場所を確認できます。";
      break;
    case "/search":
      title = "検索 | 宇部高専文化祭2025";
      description =
        "宇部高専文化祭2025のコンテンツ検索。イベント、展示、屋台を検索できます。";
      break;
    case "/bookmarks":
      title = "ブックマーク | 宇部高専文化祭2025";
      description =
        "お気に入りのイベント、展示、屋台をブックマークして管理できます。";
      break;
    case "/sponsors":
      title = "協賛企業 | 宇部高専文化祭2025";
      description =
        "宇部高専文化祭2025を支援していただいている協賛企業のご紹介。";
      break;
  }
