import{o as m,j as r,L as h}from"./index-CAuNCEbi.js";/**
 * @license lucide-react v0.545.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const g=[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"m12 5 7 7-7 7",key:"xquz4c"}]],f=m("arrow-right",g),j=({to:e,href:o,onClick:c,children:i,variant:l="secondary",size:u="md",className:d="",disabled:s=!1,external:n=!1})=>{const v=`
  ...
  `,p=()=>{switch(l){case"primary":return`
        ...
        `;default:return""}},x=()=>r.jsx("span",{className:"transition-all duration-200 group-hover:translate-x-1/12 ml-1/2 flex-shrink-0",children:r.jsx(f,{size:16})}),t=r.jsxs(r.Fragment,{children:[r.jsx("span",{className:"relative",children:i}),(e||o)&&r.jsx(x,{})]}),a={className:`${v} ${p()}`,disabled:s};return e&&!s?r.jsx(h,{to:e,...a,children:t}):o&&!s?r.jsx("a",{href:o,...a,target:n?"_blank":void 0,rel:n?"noopener noreferrer":void 0,children:t}):r.jsx("button",{onClick:c,...a,children:t})};export{j as P};
